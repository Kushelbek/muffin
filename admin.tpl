...
<aside class="left-sidebar">
	...
	<div class="scroll-sidebar">
		...
		<div class="user-profile">
			<!-- User profile image -->
			<div class="profile-img"> <img src="<!-- IF {PHP.usr.profile.user_avatar} -->{PHP.usr.profile.user_avatar|cot_files_user_avatar_url($this)}<!-- ELSE -->datas/defaultav/blank.png<!-- ENDIF -->" alt="{PHP.usr.profile.user_name}" />
