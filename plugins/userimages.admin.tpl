...
{FILE "{PHP.cfg.themes_dir}/admin/{PHP.cfg.admintheme}/warnings.tpl"}
					<div class="block">
						<h5><i class="fa fa-picture-o"></i> {PHP.L.userimages_title}</h5>
						<div class="wrapper">
								...
								<form action="{EDIT_URL}" method="post">
									<tr>
										...
										<td class="action centerall replaceLink">
											<div class="btn-group">
												<button class="btn btn-default btn-{PHP.R.admin-config-buttonsize2}" type="submit"><i class="mdi mdi-reload"></i> <span>{PHP.L.Update}</span></button>
									...
									<form action="{PHP|cot_url('admin','m=other&p=userimages&a=add')}" method="post">
										<tr>
											...
											<td class="action centerall">
												<button type="submit" class="btn btn-primary btn-{PHP.R.admin-config-buttonsize2}"><i class="fa fa-plus-circle"></i> <span>{PHP.L.Add}</span></button>
											</td>
										<tr>
									</form>
								</tfoot>
