...
<div class="col-md-6">
    <div class="card">
        <div class="card-body">
            <h5><i class="mdi mdi-search-web"></i> {PHP.L.ipsearch_title}</h5>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>{IPSEARCH_USER_LASTIP_IPMASK1}</td>
                </tr>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>{IPSEARCH_USER_LASTIP_IPMASK2}</td>
                </tr>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>{IPSEARCH_USER_LASTIP_IPMASK3}</td>
                </tr>
...
<div class="col-md-6">
    <div class="card">
        <div class="card-body">
            <h5><i class="mdi mdi-search-web"></i> {PHP.L.ipsearch_searchthisuser}:</h5>
